...
import FooterLogo from "../assets/images/koho-logo.png";
import icon from "../assets/images/resources/email-128x.png";
          ...
          <div className="inner-container">
            ...
            <form action="#" className="mailchimp-one__form">
              <input
                ...
                name="email"
              />
              <button className="sd-btn mailchimp-one__btn" type="submit">
        ...
        <div className="site-footer__upper">
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-8 d-flex align-items-center justify-content-xl-end justify-content-lg-end justify-content-md-center justify-content-sm-center">
  <div className="footer-widget">
      ...
      <a href="#none">
        ...
        <div className="site-footer__bottom">
          <div className="container text-center">
            <p>© copyright 2024 by Femi Sowemimo</p>
          </div>
        </div>
      </footer>
    </div>
